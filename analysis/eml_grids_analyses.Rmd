...
newer_results_subdirs = c("basic", "slower", "fewer")

language_results_subdirs = c("language", "fewer_with_library/language")
language_homm_results_subdirs = c("language_HoMM", "fewer_with_library/language_HoMM")
library_results_subdirs = c("basic_with_library", "fewer_with_library_non_persistent")

hold_out_regex = "red_blue_True|forest_orange_True"
