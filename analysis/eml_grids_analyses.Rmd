...
result_subdirs = c(#"results_0", 
                   ...
                   #"results_84", "results_85",
                   #"results_86", #"results_87",
                   #"results_88",
                   #"results_89", "results_90", "results_91", "results_92",
                   #"results_93", "results_94" #"results_95", "results_96"
                   
                   )

newer_results_subdirs = c(#"results_100", 
                          #"results_101", #"results_102", 
                          #"results_103",
                          #"results_104", "results_105",
                          #"results_106",
                          #"results_107", "results_108", "results_109",
                          #"results_110", "results_111",
                          #"results_112", "results_113", "results_114",
                          #"results_115", "results_116",
                          # weight norm
                          #"results_117"
  )
...
```{r}
config_d = load_d(results_dir, result_subdirs, F, "config")
config_d = bind_rows(config_d,
                     load_d(results_dir, newer_results_subdirs, num_runs, "config"))
```
```{r}
config_d = config_d %>% 
  rowwise() %>% 
...
```{r}
base_d = load_d(results_dir, result_subdirs, F, "base_losses")
base_d = bind_rows(base_d,
                   load_d(results_dir, newer_results_subdirs, num_runs, "base_losses"))
```
...
```{r}
meta_d = load_d(results_dir, result_subdirs, F, "meta_true_losses")
meta_d = bind_rows(meta_d,
                   load_d(results_dir, newer_results_subdirs, num_runs, "meta_true_losses"))
```
...
ggplot(meta_d %>%
         filter(meta_task == "switch_colors",
                run_type %in% c("results_113", "results_115", "results_116")),
       aes(x=epoch, y=returns_mean, color=source_game_type, linetype=interaction(eval, source_is_eval))) +
  geom_line(stat="summary",
            fun.y="mean") +
  geom_hline(yintercept=0,
