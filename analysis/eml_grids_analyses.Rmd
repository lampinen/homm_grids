...
language_results_subdirs = c("one_holdout_7/language", "lessplit_wn_one_holdout/language")
library_results_subdirs = c("one_holdout_7", "lessplit_one_holdout", "lessplit_wn_one_holdout", "lesssplit_narrower_one_holdout", "lesssplit_smaller_one_holdout")
...
ggplot(data=comparison_d %>%
  ...
  labs(x="Task", y="Normalized returns (zero-shot)") +
