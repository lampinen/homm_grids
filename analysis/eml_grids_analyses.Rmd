...
g = ggplot(data=comparison_d %>%
  ...
  annotate("text", x=0.48, y=0.1, alpha=0.5, label="Chance") +
  annotate("text", x=0.83, y=1.1, alpha=0.5, label="Optimal adaptation") +
  annotate("text", x=0.69, y=-1.1, alpha=0.5, label="No adaptation") +
  scale_y_continuous(breaks = c(-1, -0.5, 0, 0.5, 1), labels = c("-100%", "-50%", "0%", "50%", "100%")) +
