...
language_homm_results_subdirs = c("../language_HoMM_results/language_HoMM_refixed")
...
ggsave("../../metamapping_paper/figures/grids_adaptation_revised.png", width=4, height=3)
