...
ggsave("../../metamapping_paper/figures/grids_language_learning_curves.png", width=4, height=3)
ggsave("../../../psych/dissertation/4-extending/figures/grids_language_learning_curves.png", width=4, height=3)
``` 
...
ggsave("../../../psych/dissertation/4-extending/figures/grids_adaptation_results.png", width=4, height=3)
```
...
for (this_lang_criterion in c("strict", "loose")) {
  ...
  ggsave(sprintf("../../../psych/dissertation/4-extending/figures/grids_adaptation_correlation_%s.png", this_lang_criterion), width=4, height=3)
}
```
...
ggplot(data=comparison_d %>%
  ...
  guides(color=guide_legend(title=NULL)) +
  theme(legend.position=c(0.85, 0.25)) 
ggsave("../../metamapping_paper/figures/grids_hyper_vs_tcnh.png", width=4, height=3)
ggsave("../../../psych/dissertation/4-extending/figures/grids_hyper_vs_tcnh.png", width=4, height=3)
```
...
ggplot(data=eval_d %>%
         mutate(base_task_toe=factor(base_task_toe,
                                     ...
                                     labels=c("Trained examples", "Held-out examples"))) %>%
...
ggsave("../../metamapping_paper/figures/grids_behavioral_uncertainty.png", width=4, height=3)
...
ggsave("../../metamapping_paper/figures/grids_behavioral_uncertainty_by_score_diff.png", width=4, height=3)
